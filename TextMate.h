...
- (id)stringByDeletingLastPathComponentOrNil;
- (id)lastPathComponentOr:(id)arg1;
...
@interface NSSavePanel (ShowHiddenFilesCheckBox)
- (void)setShowsHiddenFilesCheckBox:(BOOL)arg1;
@end
